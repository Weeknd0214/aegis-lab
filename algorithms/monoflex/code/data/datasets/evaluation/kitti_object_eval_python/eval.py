...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    CLASS_NAMES = ['car', 'truck', 'bus', 'pedestrian', 'cyclist', 'largemiscv']
    MIN_HEIGHT = [40, 25, 25]
    MAX_OCCLUSION = [0, 1, 2]
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None, metric='R40'):
    ...
    class_to_name = {current_classes.index(cls):cls for cls in current_classes}
    name_to_class = {cls: current_classes.index(cls) for cls in current_classes}
