...
_C.INPUT.WIDTH_TRAIN = 736
# Size of the smallest side of the image during testing
_C.INPUT.HEIGHT_TEST = 384
# Maximum size of the side of the image during testing
_C.INPUT.WIDTH_TEST = 736

_C.INPUT.REF_FOCAL_LENGTH = 800.0
...
_C.MODEL.HEAD.DEPTH_RANGE = [0.1, 320]
...
_C.MODEL.HEAD.DIMENSION_MEAN = ((3.8840, 1.5261, 1.6286), # Car
                               (15.0001, 3.7001, 3.2001), # Truck
                               (0.8423, 1.7607, 0.6602), # Pedestrian
                               (1.7635, 1.7607, 0.6602), # Cyclist
                               (2.7635, 1.9372, 1.6286), # Tricyclist
                               (10.7635, 3.7001, 3.2001), # Bus
                               (0.6003, 0.8003, 0.6003)) # TrafficCone

# since only car and pedestrian have enough samples and are evaluated in KITTI server 
_C.MODEL.HEAD.DIMENSION_STD = ((0.4259, 0.1367, 0.1022), # Car
                              (0.4759, 0.1867, 0.1522), # Truck
                              (0.2349, 0.1133, 0.1427), # Pedestrian
                              (0.1766, 0.0948, 0.1242), # Cyclist
                              (0.2766, 0.1948, 0.1242), # Tricyclist
                              (0.2766, 0.1867, 0.1522), # Bus
                              (0.1766, 0.2867, 0.1766)) # TrafficCone
